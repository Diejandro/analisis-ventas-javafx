...
<details>
  ...
  ### Vista del Dashboard
  ![Dashboard Principal](screenshots/dashboard_general.png)
  *Resumen de métricas y flujo de ventas por niveles.*

  ### Gráficos de Análisis
  ![Sección de Gráficos](screenshots/graficos_analisis.png)
  *Visualización de tendencias y comparativa de productos.*

  ### Reporte HTML
  ![Vista de Informe](screenshots/vista_informe.png)
  *Ejemplo del informe generado por la aplicación.*

  ### Formulario de entrada
  ![Modal de Entrada](screenshots/modal_datos.png)
